...
TXT_LEFT	=	108	; Left position of input text area.  40 col = 72
TXT_WIDE	=	120	; Width of input text area.  40 col = 80
BOX_WIDE	=	TXT_LEFT+TXT_WIDE+8
BOX_LEFT	=	(640-BOX_WIDE)/2
LBL_LEFT	=	BOX_LEFT+8
...
checkbox:	.word	unckIcon	;or ckIcon
	.byte	((BOX_LEFT+TXT_LEFT)-32)/8					;x position in cards
	.byte	BOX_TOP+(TTL_HIGH+8)+(ITM_HIGH*NUM_ITEM)-4	;y position in cards
	.byte	3,16
	.word	dhToggle
;	------------------------------------------------
okPtr:	.word	okIcon
	.byte	OK_LEFT/8,ICON_TOP	;x, y position in cards
	.byte	6,16				;x width, y width in cards
okVect:	.word	doOK
;	------------------------------------------------
