...
@20:	jsr	getMods	;get module locations on disk
	...
	jmp	EnterDeskTop
@30:
	ldy	#K_CINIT	;check for network card
...
; -----------------------------------------------------------
mainMenu:	.byte	0,14			; top, bottom of menu
	.word	0,134					; left, right of menu
	.byte	HORIZONTAL | 2
;	------------------------------------------------
	.word	geosText
	.byte	SUB_MENU
...
; -----------------------------------------------------------
geosMenu:	.byte	15,30			; top, bottom of menu
	.word	0,48					; left, right of menu
...
; -----------------------------------------------------------
optMenu:	.byte	15,72			; top, bottom of menu
	.word	28,134					; left, right of menu
...
; -----------------------------------------------------------
deadMenu:	.byte	15,72			; top, bottom of menu
	.word	28,134					; left, right of menu
	.byte	VERTICAL | CONSTRAINED | 4
;	------------------------------------------------
	.word	deadSetup
...
infoDB:	.byte	DEF_DB_POS | 1
	...
	.word	infoMsg4
	.byte	DBTXTSTR,TXT_LN_X,TXT_LN_5_Y
	.word	infoMsg5
	.byte	0
...
infoMsg3:	.byte	"GEOS 128 support: Alex Burger",0
infoMsg4:	.byte	"network stack: ip65",0
infoMsg5:	.byte	"(Per Olofsson, Jonno Downes)",0
; -----------------------------------------------------------
; error dialog box
; -----------------------------------------------------------
...
setDB:	.byte	DEF_DB_POS | 1
	.byte	DBTXTSTR,DBI_X_2 * 8 - 6,11
	.word	setSelct
	.byte	DBGETFILES,4,4
	.byte	OPEN,DBI_X_2,21
	.byte	CANCEL,DBI_X_2,45
	.byte	0
setSelct:	.byte	"Select settings file:",0
; ------------------------------------------------------------
...
port:	.res	6
nick:	.res	NICKLEN+1		; 15 in geoLink.inc
passwd:	.res	10
